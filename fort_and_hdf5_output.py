...
import pysac.io.legacy as sacio

#infile = sacio.VACdata("fredatmos.ini")
infile = sacio.VACdata("3D_tube_128_128_128.ini")
print infile

#outfile = sacio.VACdata("testout.out",mode='w')
outfile = sacio.VACfile("3D_tube_128_128_128.gdf",mode='w')
...
print header['nw'], infile.w.shape
print header['nx'], infile.x.shape
