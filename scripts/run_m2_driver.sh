...
#./configure.py set SAC --usr_script="m2" --grid_size=128,256,256 --runtime=1.1 --mpi_config=np040402
#./configure.py set SAC --usr_script="m2" --grid_size=132,260,260 --runtime=200 --mpi_config=np010408
./configure.py set SAC --usr_script="m2" --grid_size=132,132,132 --runtime=200 --mpi_config=np010408
