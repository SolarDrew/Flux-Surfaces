...
#    
    ...
    for field in fields.values():
        ...
        x = np.ascontiguousarray(np.array(field['field']))
...
#full_nx = [nx[1]*n1, nx[2]*n2, nx[0]*n0]
header['nx'] = full_nx
...
#print '[coords - process {}]'.format(rank), coords
s = map(int, coords * nx)
...
# Save a gdf file
#==============================================================================
for i in [0]:#range(0,vfile.num_records,1):
    ...
    print os.path.join(output_path, cfg.get_identifier()+'_{:05d}.gdf'.format(i+1))
